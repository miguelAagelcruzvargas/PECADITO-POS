        ...
        <div className="bg-white border border-pink-50 rounded-[32px] p-6 shadow-xl shadow-pink-100/10 space-y-5 flex flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-8 flex-1">
            ...
            <div className="flex flex-col">
              <p className="text-[11px] text-gray-400 font-bold uppercase tracking-[0.2em] mb-4 flex items-center gap-2"><FaEye /> Vista Previa Real</p>
              <div className="flex-1 bg-gray-100 rounded-3xl p-4 border-2 border-dashed border-gray-300 flex items-center justify-center">
                <div 
                  className="bg-white shadow-xl p-4 font-mono text-black overflow-hidden pointer-events-none"
                  style={{ 
                ...
                >
                  <div className="text-center border-b border-dashed border-gray-300 pb-2 mb-2">
                    ...
                    {ticketConfig.ticket_decoration !== 'none' && (
                      <div className="text-[10px] mt-2 border-t border-b border-gray-100 py-1 bg-gray-50/50">
                        {ticketConfig.ticket_decoration === 'hearts' ? '❤️ ❤️ ❤️' : 
                         ticketConfig.ticket_decoration === 'desserts' ? '🍰 🍓 🍦' : '⭐ ⭐ ⭐'}
                      </div>
                    )}
                  </div>
